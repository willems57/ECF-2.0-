...
function ajttrajet(){
    ...
    fetch("https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/trajets", requestOptions)
...
fetch("https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/trajetsencours", requestOptions)
  .then((response) => response.text())
  .then((result) => console.log(result))
  .catch((error) => console.error(error));
}
...
function ajtvehicule(){
    ...
    fetch("https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/voitures", requestOptions)
      .then((response) => response.text())
      .then((result) => console.log(result))
      .catch((error) => console.error(error));
}
...
getInfosservice();
  ...
  function getInfosservice(){
    ...
    fetch("https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/security/account/me", requestOptions)
    .then(response =>{
        if(response.ok){
...
function trajetterminer(){
  ...
  "passager": dataForm.get(passagersInput.value)
    ...
    fetch("https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/trajetsfini", requestOptions)
      .then((response) => response.text())
      .then((result) => console.log(result))
      .catch((error) => console.error(error));
}
...
function ajtcredit() {
    ...
    fetch("https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/security/account/edit", requestOptions)
...
btntrajetfini.addEventListener("click", async () => {
  ...
  const sendMessage = async () => {
      const apiUrl = "https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/send-message";
      const data = {
          content: content,
