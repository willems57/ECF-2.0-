...
function sanitizeHtml(text) {
    ...
    function validerAvis(avisId) {
        ...
        fetch(`https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/avis`, requestOptions)
            .then((response) => {
                if (response.ok) {
...
function supprimerAvis(avisId) {
    ...
    fetch(`https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/avisvalidation/${avisId}`, requestOptions)
        .then((response) => {
            if (response.ok) {
...
function getInfosAvis() {
    ...
    fetch("https://main-bvxea6i-e2v3bbof3llnq.fr-4.platformsh.site/api/avisvalidation", requestOptions)
        .then(response => {
            if (response.ok) {
